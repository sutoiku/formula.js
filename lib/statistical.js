...
exports.AVERAGEIFS = function() {
  ...
  var args = exports.ARGSTOARRAY(arguments);
...
exports.BETADIST = function(x, alpha, beta, cumulative, A, B) {
...
exports.BETAINV = function(probability, alpha, beta, A, B) {
  A = (typeof A === 'undefined') ? 0 : A;
  B = (typeof B === 'undefined') ? 1 : B;
  return jStat.beta.inv(probability, alpha, beta) * (B - A) + A;
};

exports.BINOMDIST = function(successes, trials, probability, cumulative) {
...
exports.COVARIANCEP = function(array1, array2) {
...
exports.COVARIANCES = function() {
  return jStat.covariance.apply(this, arguments);
};

exports.DEVSQ = function() {
  var range = exports.ARGSCONCAT(arguments);
...
exports.EXPONDIST = function(x, lambda, cumulative) {
  return (cumulative) ? jStat.exponential.cdf(x, lambda) : jStat.exponential.pdf(x, lambda);
};

exports.FDIST = function(x, d1, d2, cumulative) {
  return (cumulative) ? jStat.centralF.cdf(x, d1, d2) : jStat.centralF.pdf(x, d1, d2);
};

//TODO
exports.FDISTRT = function() {
  return;
};

exports.FINV = function(probability, d1, d2) {
...
//TODO
exports.FINVRT = function() {
  return;
};

//TODO
exports.FTEST = function() {
  return;
};
...
//TODO
exports.GAMMADIST = function( /* x, alpha, beta, cumulative */ ) {
  return;
};

//TODO
exports.GAMMAINV = function( /* probability, alpha, beta */ ) {
  return;
};
...
//TODO
exports.GAMMALNPRECISE = function() {
  return;
};
...
exports.GEOMEAN = function() {
  return jStat.geomean(exports.ARGSCONCAT(arguments));
};
...
exports.HYPGEOMDIST = function(x, n, M, N, cumulative) {
  function pdf(x, n, M, N) {
    return exports.COMBIN(M, x) * exports.COMBIN(N - M, n - x) / exports.COMBIN(N, n);
  }
...
exports.INTERCEPT = function(data_y, data_x) {
  return exports.FORECAST(0, data_y, data_x);
};
...
exports.LOGNORMDIST = function(x, mean, sd, cumulative) {
  return (cumulative) ? jStat.lognormal.cdf(x, mean, sd) : jStat.lognormal.pdf(x, mean, sd);
};

exports.LOGNORMINV = function(probability, mean, sd) {
...
exports.MODESNGL = function() {
  return exports.MODEMULT(arguments).sort(function(a, b) {
    return a - b;
  })[0];
};
...
exports.NORMDIST = function(x, mean, sd, cumulative) {
  // Check parameters
...
exports.NORMINV = function(probability, mean, sd) {
...
exports.NORMSINV = function(probability) {
...
exports.PERMUT = function(number, number_chosen) {
  return exports.FACT(number) / exports.FACT(number - number_chosen);
};
...
exports.QUARTILEEXC = function(range, quart) {
  switch (quart) {
    case 1:
...
exports.QUARTILEINC = function(range, quart) {
  switch (quart) {
    case 1:
...
exports.RANKAVG = function(number, range, order) {
  ...
  var count = exports.COUNTIN(range, number);
  return (count > 1) ? (2 * range.indexOf(number) + count + 1) / 2 : range.indexOf(number) + 1;
};

exports.RANKEQ = function(number, range, order) {
  order = (typeof order === 'undefined') ? false : order;
  var sort = (order) ? function(a, b) {
    return a - b;
  } : function(a, b) {
...
exports.TDIST = function(x, df, cumulative) {
  return (cumulative) ? jStat.studentt.cdf(x, df) : jStat.studentt.pdf(x, df);
};

//TODO
exports.TDIST2T = function() {
  return;
};

//TODO
exports.TDISTRT = function() {
  return;
};

//TODO
exports.TINV = function(probability, df) {
  return jStat.studentt.inv(probability, df);
};

//TODO
exports.TINV2T = function() {
  return;
};

//TODO
exports.TTEST = function() {
  return;
};
...
exports.TRIMMEAN = function(range, percent) {
  range = utils.flatten(range);
  var trim = exports.FLOOR(range.length * percent, 2) / 2;
  return jStat.mean(_.initial(_.rest(range.sort(function(a, b) {
    return a - b;
  }), trim), trim));
};

exports.VARP = function() {
  var range = utils.numbers(utils.flatten(arguments));
  var n = range.length;
  var sigma = 0;
  var count = 0;
...
exports.ZTEST = function(range, x, sigma) {
  var n = range.length;
  var sd = (typeof sigma === 'undefined') ? exports.STDEVS(range) : sigma;
  return 1 - exports.NORMSDIST((exports.AVERAGE(range) - x) / (sd / Math.sqrt(n)), exports.TRUE);
};