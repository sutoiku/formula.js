...
exports.AGGREGATE = function(function_num, options, ref1, ref2) {
  switch (function_num) {
    ...
    case 7:
      return statistical.STDEVS(ref1);
    case 8:
      return statistical.STDEVP(ref1);
    case 9:
    ...
    case 13:
      return statistical.MODESNGL(ref1);
    case 14:
    ...
    case 17:
      return statistical.QUARTILEINC(ref1, ref2);
    case 18:
      return statistical.PERCENTILEEXC(ref1, ref2);
    case 19:
      return statistical.QUARTILEEXC(ref1, ref2);
  }
};
...
exports.SUBTOTAL = function(function_code) {
  var result = [];
  for (var i = 1; i < arguments.length; i++) {
    switch (function_code) {
      case 1:
        result[i - 1] = exports.AVERAGE(arguments[i]);
        break;
      case 2:
        result[i - 1] = exports.COUNT(arguments[i]);
        break;
      case 3:
        result[i - 1] = exports.COUNTA(arguments[i]);
        break;
      case 4:
        result[i - 1] = exports.MAX(arguments[i]);
        break;
      case 5:
        result[i - 1] = exports.MIN(arguments[i]);
        break;
      case 6:
        result[i - 1] = exports.PRODUCT(arguments[i]);
        break;
      case 7:
        result[i - 1] = exports.STDEV(arguments[i]);
        break;
      case 8:
        result[i - 1] = exports.STDEVP(arguments[i]);
        break;
      case 9:
        result[i - 1] = exports.SUM(arguments[i]);
        break;
      case 10:
        result[i - 1] = exports.VAR(arguments[i]);
        break;
      case 11:
        result[i - 1] = exports.VARP(arguments[i]);
        break;
    }
  }
  return result;
...
exports.SUMIFS = function() {
  ...
  var range = exports.FLATTEN(args.shift());
  var criteria = args;
...
exports.SUMSQ = function() {
  ...
  for (var i = 0; i < length; i++) {
    result += (exports.ISNUMBER(numbers[i])) ? numbers[i] * numbers[i] : 0;
  }
  return result;
};
...
exports.SUMX2MY2 = function(array_x, array_y) {
  var result = 0;
  array_x = exports.FLATTEN(array_x);
  array_y = exports.FLATTEN(array_y);
