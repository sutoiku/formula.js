...
exports.ACCRINT = function(issue, first, settlement, rate, par, frequency, basis, method) {
  ...
  // Set default values
  par = (par === undefined) ? 0 : par;
  basis = (basis === undefined) ? 0 : basis;
  method = (method === undefined) ? true : false;

  var factor = dateTime.YEARFRAC(issue, settlement, basis);
  return par * (rate / frequency) * factor;
};
...
exports.FVSCHEDULE = function(principal, schedule) {
  schedule = utils.flatten(schedule);
