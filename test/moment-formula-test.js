...
describe("test formula integration with momentjs", function() {
    ...
    describe("test MOMENTADD", function() {
        it("should correctly evaluate when i add 1 day to 20-12-1963", function() {
            Formulae.MOMENTADD(new Date(1963, 11, 20), 1, 'days').should.eql(moment([1963, 11, 21]).toDate());
        });

        it("should correctly evaluate when i add 1 week to 20-12-1963", function() {
            Formulae.MOMENTADD(new Date(1963, 11, 20), 1, 'weeks').should.eql(moment([1963, 11, 27]).toDate());
        });

        it("should correctly evaluate when i add 1 month to 20-12-1963", function() {
            Formulae.MOMENTADD(new Date(1963, 11, 20), 1, 'month').should.eql(moment([1964, 0, 20]).toDate());
        });
    });
    ...
    describe("test MOMENTUTC", function() {
        it("should correctly evaluate evaluate 20", function() {
            Formulae.MOMENTUTC([1963, 11, 20]).should.eql(new Date(Date.UTC(1963, 11, 20)));
        });
    });
